                ...
                if(sr>dr && sc<dc)
                {
                    for(i=1;i<sr-dr;i++)
                    {
                        if(chess[sr-i][sc+i].pieceatxy!=0)
                        {
                            ...
                            {
                                cout<<"Tapaiko aafnai piece cha tyaha";
                                cout<<"Khana mildaina";
                                return 0;
                            }
                            else
                            {
                                label3:
                                    cout<<"Ke tapai yo piece khana chahanu huncha? (y/n):";
                                        cin>>reply;
                                        if(reply=='y' || reply=='Y')
                                        {
                                            dr=dr+(dr-sr-i);
                                        ...
                                        {
                                            cout<<"Yesari chalna mildaina";
                                            return 0;
                                        }
                                        else
                                        {
                                            cout<<"\nKripaya nirdeshan anusar jawaf dinuhola";
                                            goto label3;
                ...
                else if(sr<dr && sc>dc)
                {
                    for(i=1;i<dr-sr;i++)
                    {
                        if(chess[sr+i][sc-i].pieceatxy!=0)
                        {
                            ...
                            {
                                label4:
                                    cout<<"Ke tapai tyo piece khana chahanu huncha? (y/n):";
                                        cin>>reply;
                                        if(reply=='y' || reply=='Y')
                                        {
                                            dr=dr-(dr-sr-i);
                    ...
                    if(dc<=sc)
                    {
                        for(i=sc-1;i>=dc+1;i--)
                        {
                            if(chess[sr][i].pieceatxy!=0)
                            {
                                ...
                                {
                                    cout<<"\nTapaiko aafnai piece cha tyaha\n";
                                    cout<<"Can't attack\n";
                                    return 0;
                                }
...
int main()
{
    ...
    obj.display();
    int timer =0;
    cout<<"Kaustuv Chess V6.9"<<endl;
    cout<<"\nGame Suru Garau: "<<endl;
    ...
    cout<<"Gotti ko suru ko row ra column lekhnuhos: ";
    cin>>sr>>sc;
    cout<<"\nGantavya ko row ra column lekhnuhos :";
    cin>>dr>>dc;
